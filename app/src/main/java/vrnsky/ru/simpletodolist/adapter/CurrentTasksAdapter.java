...
/**
 * Adapter which service for correct showing current task.
 */
public class CurrentTasksAdapter extends TaskAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case TYPE_TASK:
                ...
                TextView name = (TextView) v.findViewById(R.id.tvTaskName);
                TextView date = (TextView) v.findViewById(R.id.tvTaskDate);
                CircleImageView priority = (CircleImageView) v.findViewById(R.id.cvTaskPriority);
                return new TaskViewHolder(v, title, date, priority, name);
            case TYPE_SEPARATOR:
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (item.isTask()) {
            ...
            taskViewHolder.name.setTextColor(resources.getColor(R.color.primary_text_default_material_light));
            ...
            taskViewHolder.priority.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    taskViewHolder.name.setTextColor(resources.getColor(R.color.primary_text_disabled_material_light));
